...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Initiator</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.papyrus.acs.profile.model.impl.InitiatorImpl#getBase_StateMachine <em>Base State Machine</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InitiatorImpl extends TypInOutImpl implements Initiator {
	/**
	...
	protected EClass eStaticClass() {
		return AcsProfilePackage.Literals.INITIATOR;
	}
		...
		if (base_StateMachine != null && base_StateMachine.eIsProxy()) {
			...
			if (base_StateMachine != oldBase_StateMachine) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AcsProfilePackage.INITIATOR__BASE_STATE_MACHINE, oldBase_StateMachine, base_StateMachine));
			}
		}
	...
	public void setBase_StateMachine(StateMachine newBase_StateMachine) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AcsProfilePackage.INITIATOR__BASE_STATE_MACHINE, oldBase_StateMachine, base_StateMachine));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AcsProfilePackage.INITIATOR__BASE_STATE_MACHINE:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == EventDeclaration.class) {
			switch (derivedFeatureID) {
				case AcsProfilePackage.INITIATOR__BASE_STATE_MACHINE: return AcsProfilePackage.EVENT_DECLARATION__BASE_STATE_MACHINE;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == EventDeclaration.class) {
			switch (baseFeatureID) {
				case AcsProfilePackage.EVENT_DECLARATION__BASE_STATE_MACHINE: return AcsProfilePackage.INITIATOR__BASE_STATE_MACHINE;
				default: return -1;
			}
		}
