...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>COM State</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.papyrus.acs.profile.model.impl.COMStateImpl#getBase_State <em>Base State</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class COMStateImpl extends MinimalEObjectImpl.Container implements COMState {
	/**
	...
	protected EClass eStaticClass() {
		return AcsProfilePackage.Literals.COM_STATE;
	}
		...
		if (base_State != null && base_State.eIsProxy()) {
			...
			if (base_State != oldBase_State) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AcsProfilePackage.COM_STATE__BASE_STATE, oldBase_State, base_State));
			}
		}
		return base_State;
	}
	...
	public void setBase_State(State newBase_State) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AcsProfilePackage.COM_STATE__BASE_STATE, oldBase_State, base_State));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AcsProfilePackage.COM_STATE__BASE_STATE:
