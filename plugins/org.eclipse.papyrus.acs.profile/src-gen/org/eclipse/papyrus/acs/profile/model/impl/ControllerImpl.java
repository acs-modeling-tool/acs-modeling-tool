 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.papyrus.acs.profile.model.impl.ControllerImpl#getBase_StateMachine <em>Base State Machine</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ControllerImpl extends MinimalEObjectImpl.Container implements Controller {
	...
	protected EClass eStaticClass() {
		return AcsProfilePackage.Literals.CONTROLLER;
	}
		...
		if (base_StateMachine != null && base_StateMachine.eIsProxy()) {
			...
			if (base_StateMachine != oldBase_StateMachine) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AcsProfilePackage.CONTROLLER__BASE_STATE_MACHINE, oldBase_StateMachine, base_StateMachine));
			}
		}
	...
	public void setBase_StateMachine(StateMachine newBase_StateMachine) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AcsProfilePackage.CONTROLLER__BASE_STATE_MACHINE, oldBase_StateMachine, base_StateMachine));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AcsProfilePackage.CONTROLLER__BASE_STATE_MACHINE:
