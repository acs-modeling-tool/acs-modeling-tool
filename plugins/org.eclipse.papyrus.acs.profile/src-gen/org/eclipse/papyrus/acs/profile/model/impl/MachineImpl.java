 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.papyrus.acs.profile.model.impl.MachineImpl#getBase_Region <em>Base Region</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class MachineImpl extends MinimalEObjectImpl.Container implements Machine {
	...
	protected EClass eStaticClass() {
		return AcsProfilePackage.Literals.MACHINE;
	}
		...
		if (base_Region != null && base_Region.eIsProxy()) {
			...
			if (base_Region != oldBase_Region) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AcsProfilePackage.MACHINE__BASE_REGION, oldBase_Region, base_Region));
			}
		}
		return base_Region;
	}
	...
	public void setBase_Region(Region newBase_Region) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AcsProfilePackage.MACHINE__BASE_REGION, oldBase_Region, base_Region));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AcsProfilePackage.MACHINE__BASE_REGION:
